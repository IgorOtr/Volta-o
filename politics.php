            ...
            <div class="row mb-5">
                ...
                <div class="col-md-8">
                    <div class="terms_card">
                        ...
                        <p>
                            A sua privacidade é importante para nós. É política do <span style="color: #ffc800;">Volta
                                Redonda Futebol Clube</span> respeitar
                            a sua privacidade em relação a qualquer informação sua que possamos coletar no site Volta
                            Redonda Futebol Clube, e outros sites que possuímos e operamos.<br><br>
                            ...
                            Também informamos por que estamos coletando e como será usado.<br><br>
                            ...
                            exceto quando exigido por lei.<br><br>
                            ...
                            responsabilidade por suas respectivas <span style="color: #ffc800;">políticas de
                                privacidade</span>.<br><br>

                            Você é livre para recusar a nossa solicitação de informações pessoais, entendendo que talvez
                            não possamos fornecer alguns dos serviços desejados.<br><br>
                            ...
                            dados do usuário e informações pessoais, entre em contacto conosco.<br><br>
                        </p>
                        ...
                        <p>
                            O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Volta
                            Redonda Futebol Clube oferece no site e com caráter enunciativo, mas não limitativo:
                        </p>
                        ...
                        <ol>
                            ...
                            <li>
                                Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, pix bet365 ou azar,
                                qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos
                                humanos;
                            </li>
                            <li>
                                Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Volta Redonda
                                Futebol Clube, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus
