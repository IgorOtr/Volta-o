<?php
    ...
    $banners = $class->getAllBanners();
    $bannerToEdit = $class->getBannerFromID($id);
...
?>
                ...
                <div class="col-md-12">
                    ...
                    <?php }else{?>
                        ...
                        <form class="" action="src/controllers/BannerController.php" method="post"
                            ...
                            <div class="mb-3 mt-5 text-center">
                                <button type="submit" class="btn btn-warning w-100" name="add_banner">Enviar
                                    Publicidade</button>
                            </div>
                        </form>
        ...
        <div class="container pb-5">
            <div class="row mb-5 mt-5">
                <div class="col-md-12 text-center">
                    <h1 class="page__title">Publicidades Adicionadas</h1>
                </div>
            </div>
            <table class="table table-dark table-striped table-hover mb-5">
                ...
                <tbody class="mb-5">
                    ...
                    <?php foreach ($banners as $key => $banner) {
                        ...
                        $delete = SITE_URL.'Admin/src/controllers/BannerController.php?action=delete&id='.$banner['id'];
                        $edit = SITE_URL.'Admin/banner.php?action=edit&id='.$banner['id'];
                    ?>

                    <div class="modal fade" id="exampleModal<?php echo $banner['id']?>" tabindex="-1"
                    ...
                    <tr>
                        ...
                        <td><img width="210" src="public/img/banners/<?php echo $banner['banner_image']?>" alt=""></td>
