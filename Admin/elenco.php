<?php
    ...
    $playerToEdit = $class->selectPlayerToEdit($id);
            ...
            <div class="row">
                <div class="col">
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        Está página deve ser utilizada para <strong>gerenciar o elenco e comissão técnica do
                            time.</strong>
        ...
        <div class="container mb-5">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php foreach ($playerToEdit as $key => $data) {?>
                    ...
                    <form class="" action="src/controllers/ElencoController.php" method="post"
                        ...
                        <div class="mb-3 d-flex flex-column">
                            ...
                            <img width="150" src="public/img/elenco/<?php echo $data['player_image']?>" alt="">
                        </div>

                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Nome do Membro:
                                <small>(Opicional)</small></label>
                            <input type="text" class="form-control" value="<?php echo $data['player_name']?>"
                                name="player_name" id="exampleFormControlInput1" placeholder="Adicionar um link:">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="player_type" id="exampleFormControlInput1">
                                <option value="<?php echo $data['player_type']?>" selected><?php echo $data['player_position']?></option>
                        ...
                        <div class="mb-3 mt-5 text-center">
                            ...
                            <button type="submit" class="btn btn-warning w-100" name="edit_member">Confirmar Alteração</button>
                        </div>
                    </form>
                    ...
                    <form class="" action="src/controllers/ElencoController.php" method="post"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="player_name" id="exampleFormControlInput1"
                                placeholder="Nome do Jogador ou Membro da Comissão Técnica:">
                        </div>
                        ...
                        <div class="mb-3 mt-5 text-center">
                            <button type="submit" class="btn btn-warning w-100" name="add_member">Adicionar
                                Membro</button>
                        </div>
                    </form>
            ...
            <table class="table table-dark table-striped table-hover mb-5">
                ...
                <tbody class="mb-5">
                    ...
                    <?php foreach ($membros as $key => $membro) {
                        ...
                        $delete = SITE_URL.'Admin/src/controllers/ElencoController.php?action=delete&id='.$membro['id'];
                        $edit = SITE_URL.'Admin/elenco.php?action=edit&id='.$membro['id'];
                    ?>
                    ...
                    <tr>
                        ...
                        <td><img class="rounded" width="150"
                                src="public/img/elenco/<?php echo $membro['player_image']?>" alt=""></td>
